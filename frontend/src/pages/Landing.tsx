    ...
    <div className="space-y-24">
      <section className="grid gap-14 lg:grid-cols-[1.2fr_0.8fr] items-center">
        <div className="space-y-8">
          ...
          >
            <Link
              to={ROUTES.register}
              className="inline-flex items-center justify-center rounded-full bg-[#1e40af] px-6 py-3 text-base font-semibold text-white shadow-lg shadow-sky-500/20 transition hover:bg-[#2746c4]"
            >
        ...
        >
          <div className="p-8">
            <div className="rounded-3xl bg-gradient-to-br from-[#1e40af] to-[#4a7c8e] p-8 text-white shadow-lg shadow-slate-950/20">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {features.map((feature) => {
            ...
            return (
              ...
              >
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-3xl bg-[#d6e8f5] text-[#1e40af]">
          ...
          <div className="mt-8 space-y-5">
            {steps.map((step, index) => (
              <div key={step.title} className="rounded-3xl border border-[color:var(--border)] p-6">
                <span className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-[#eef6ff] text-[#1e40af] font-semibold">{index + 1}</span>
      ...
      <section className="rounded-[32px] border border-[color:var(--border)] bg-[var(--surface)] p-10 text-center shadow-lg shadow-slate-950/5">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            to={ROUTES.register}
            className="inline-flex items-center justify-center rounded-full bg-[#1e40af] px-8 py-4 text-base font-semibold text-white shadow-lg shadow-sky-500/20 transition hover:bg-[#2746c4]"
          >
            Mulai Sekarang Gratis
          </Link>
          <Link
